	...
	<div class="row-fluid">
		<div class="span9">
			<div class="row-fluid">
						...
						<div class="span11">
							<h3 style="color:<?php echo '#73235E' //echo $this->session->read('menu.inferior') ?>;border-bottom: 5px solid <?php echo '#73235E' //echo $this->session->read('menu.inferior') ?>">Beneficios del pavo<?php if($this->Session->read('Auth.User.id')){ 
						...
						<div  class="row-fluid">
							...
							<div class="span7">
								...
								<div class="row-fluid">
										...
										<div class="span12">
											<p class = "textoinfo"><?php echo substr(html_entity_decode(h($benefit['Benefit']['description'])), 0, 220) ?> </p>
