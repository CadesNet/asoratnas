      ...
      <?php foreach ($carousel as $carousels) { ?>
        ...
        <li>
        	<?php if($this->Session->read('Auth.User.id')){ ?>
				...
				<?php echo $this->Form->postLink(__("<i class='icon-remove'></i>"), array('controller'=>'Carousels','action' => 'delete', $carousels['Carousel']['id'],$categories['Category']['id'],$categories['Item']['id'],'1','item'),array('class' => 'ok btn btn-info ','escape' => false), __('Are you sure you want to delete # %s?', $carousels['Carousel']['id'])); 
			}?>
	...
	<div class="row-fluid">
		...
		<div class="row-fluid" >
			...
			<div class="span12" style="margin: 0;"  >
				 ...
				 echo $this->Form->postLink(__("<i class='icon-remove'></i>"), array('controller'=>'Ads','action' => 'delete', $ads['Ad']['id'],$categories['Category']['id'],$categories['Item']['id'],'1','item'),array('class' => 'ok btn btn-info ','escape' => false), __('Are you sure you want to delete # %s?',$ads['Ad']['id']));
				 }?>
