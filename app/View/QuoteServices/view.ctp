...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Quote Service'), array('action' => 'edit', $quoteService['QuoteService']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Quote Service'), array('action' => 'delete', $quoteService['QuoteService']['id']), null, __('Are you sure you want to delete # %s?', $quoteService['QuoteService']['id'])); ?> </li>
