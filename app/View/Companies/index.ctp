...
<div class="actions">
	...
	<?php echo $this->Html->link(__('Nueva Empresa'), array('action' => 'add'),array('class' => 'ok btn btn-info btn-large')); ?>
			<?php echo $this->Html->link(__('Mostrar Sucursales'), array('controller' => 'branches', 'action' => 'index'),array('class' => 'ok btn btn-info btn-large')); ?> <?php echo $this->Html->link(__('Nueva empresa'), array('controller' => 'branches', 'action' => 'add'),array('class' => 'ok btn btn-info btn-large')); ?>
</div>
